...
def train(env_fn, actor_critic=core.MLPActorCritic, ac_kwargs=dict(), seed=0, 
        ...
        agent = sac(env_fn, actor_critic=actor_critic, ac_kwargs=ac_kwargs, 
                    replay_size=replay_size, gamma=gamma, 
                    delayup=delayup, pi_lr=pi_lr, q_lr=q_lr, alpha=alpha,
        ...
        for t in range(total_steps): 
            ...
            if t > start_steps:
                a = agent.get_action(o)      # 按照分布采取动作！不采取确定性动作！
            else:
            ...
            # 如果达到了更新步数，之后每隔50步就update50次,更新期间每2次更新一次pi 
            ...
            if (t+1) % steps_per_epoch == 0:
                ...
                if (epoch % save_freq == 0) or (epoch == epochs):
                    torch.save(agent.ac, model_dir + '/sac_' + str(epoch) + '_ac.pt')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp_name', type=str, default='sac_HalfCheetah')
